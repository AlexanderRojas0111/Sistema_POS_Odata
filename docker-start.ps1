...
Write-Host "🐳 INICIANDO SISTEMA POS SABROSITAS CON DOCKER" -ForegroundColor Green
Write-Host "=" * 60
...
Write-Host "   🗄️  Base de datos: SQLite"
...
if ($elapsed -ge $timeout) {
    Write-Host ""
    Write-Host "❌ Timeout esperando el servicio" -ForegroundColor Red
...
Write-Host ""
Write-Host "=" * 60
Write-Host "🎊 SISTEMA SABROSITAS INICIADO EXITOSAMENTE" -ForegroundColor Green
Write-Host "=" * 60
Write-Host ""
